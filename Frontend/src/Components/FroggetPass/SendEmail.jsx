...
const inputStyle = {
  width: '100%' ,
  border : '1px solid black'// This will make the input take the full width of its parent
};
  ...
  return (
    <div style={containerStyle}>
      <div style={boxStyle}>
        ...
        <button  type="submit" className="btn btn-primary" style={{ marginTop: '20px' , width:'100px', backgroundColor:'black'}}>Send</button>
        </form>
      </div>
    </div>
  );
